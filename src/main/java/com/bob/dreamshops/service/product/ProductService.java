package com.bob.dreamshops.service.product;
...
import com.bob.dreamshops.repository.CategoryRepository;
import com.bob.dreamshops.repository.ImageRepository;
...
public class ProductService implements IProductService {
    ...
    public List<Product> searchProducts(String brand, String name, String category) {
        if (brand != null && name != null) {
            return getProductsByBrandAndName(brand, name);
        }

        if (brand != null && category != null) {
            return getProductsByCategoryAndBrand(category, brand);
        }
        ...
        // No filters = return all or empty depending on your logic
